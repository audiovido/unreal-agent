#!/usr/bin/env python3
"""
Final Test for Unreal Agent - Modern Room Creation
...
try:
    ...
    def test_modern_room():
        ...
        # Create walls (4 walls) using Box class
        result = bridge.spawn_actor(
            class_name="Box",
            location=[0, 50, 0],
            rotation=[0, 0, 0]
        ...
        # Add lighting using DirectionalLight class
        result = bridge.spawn_actor(
