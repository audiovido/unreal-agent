...
PHASE_TOOL_RULES = {
    ...
    "VALIDATE": {"get_asset_info", "get_blueprint_variable_default", "inspect_blueprint", "list_assets", "ollama_chat", "runtime_widget_verify", "runtime_actor_verify", "verify_imported_asset", "verify_blender_output", "inspect_imported_asset", "verify_scene"},
